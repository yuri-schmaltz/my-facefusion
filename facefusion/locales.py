...
LOCALES : Locales =\
{
	'en':
	{
		...
		'help':
		{
			...
			'face_selector_mode': 'use reference based tracking, simple matching, average matching or fully automatic selection',
			...
			'face_selector_age_end': 'end age of the face',
			'face_selector_region': 'region of interest (x_min y_min x_max y_max) in percent',
			...
			'reference_face_position': 'position of the reference face',
			...
			'face_mask_erosion': 'specify the degree of erosion or dilation applied to the mask',
			...
			'age_modifier_model': 'choose the model based on specific requirements',
            'age_modifier_direction': 'specify the direction of the age modification',
            'background_remover_model': 'choose the model based on specific requirements',
            'background_remover_color': 'specify the color to use for the background',
            'deep_swapper_model': 'choose the model based on specific requirements',
            'expression_restorer_model': 'choose the model based on specific requirements',
            'expression_restorer_factor': 'specify the factor of the expression restoration',
            'face_debugger_items': 'select the items to be visualized for debugging',
            'face_editor_model': 'choose the model based on specific requirements',
            'face_editor_eyebrow_direction': 'adjust the eyebrow direction',
            'face_editor_eye_gaze_horizontal': 'adjust the horizontal eye gaze',
            'face_editor_eye_gaze_vertical': 'adjust the vertical eye gaze',
            'face_editor_eye_open_ratio': 'adjust the eye open ratio',
            'face_editor_lip_open_ratio': 'adjust the lip open ratio',
            'face_editor_mouth_grim': 'adjust the mouth grim expression',
            'face_editor_mouth_pout': 'adjust the mouth pout expression',
            'face_editor_mouth_purse': 'adjust the mouth purse expression',
            'face_editor_mouth_smile': 'adjust the mouth smile expression',
            'face_editor_mouth_position_horizontal': 'adjust the horizontal mouth position',
            'face_editor_mouth_position_vertical': 'adjust the vertical mouth position',
            'face_editor_head_pitch': 'adjust the head pitch rotation',
            'face_editor_head_yaw': 'adjust the head yaw rotation',
            'face_editor_head_roll': 'adjust the head roll rotation',
            'face_enhancer_model': 'choose the model based on specific requirements',
            'face_enhancer_blend': 'blend the enhanced face with the original face',
            'face_enhancer_weight': 'specify the weight of the face enhancer',
            'face_swapper_model': 'choose the model based on specific requirements',
            'face_swapper_pixel_boost': 'adjust the pixel boost resolution',
            'face_swapper_weight': 'specify the weight of the face swapper',
            'frame_colorizer_model': 'choose the model based on specific requirements',
            'frame_colorizer_blend': 'blend the colorized frame with the original frame',
            'frame_colorizer_size': 'specify the processing size for frame colorization',
            'frame_enhancer_model': 'choose the model based on specific requirements',
            'frame_enhancer_blend': 'blend the enhanced frame with the original frame',
            'frame_expander_target_ratio': 'specify the aspect ratio of the output frame',
            'frame_expander_mode': 'specify the mode of expansion',
            'frame_expander_blur': 'specify the blur radius for span mode',
            'lip_syncer_model': 'choose the model based on specific requirements',
            'lip_syncer_weight': 'specify the weight of the lip syncer',
...
,
		...
		'uis':
		{
			...
			'face_mask_erosion_slider': 'FACE MASK EROSION',
